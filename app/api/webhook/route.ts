...
export async function POST(request: Request) {
  ...
  console.log("1 ~ file: route.ts:18 ~ POST ~ payment:", payment);
  ...
  console.log("2 ~ file: route.ts:32 ~ POST ~ offer:", offer);
  ...
  console.log("3 ~ file: route.ts:61 ~ parcela ~ parcela:", parcela);
  ...
  console.log("4 ~ file: route.ts:69 OmieOrderService.update");
  /**
  ...
  console.log("5 ~ file: route.ts:78 ~ POST ~ receive_orders:", receive_orders);
   ...
   */
  const [current_receive_order] = receive_orders.conta_receber_cadastro.filter(
    (a) =>
  ...
  console.log("6 ~ file: route.ts:78 ~ POST");

  /**
   *  notify bpay microservice with the dara received from bb webhook
   */
  await axios.post("https://bpay-rest-api.bwsoft.app/update-pix-without-recipient", data);

  console.log("7 ~ file: route.ts:78 ~ AXIOS POST");
