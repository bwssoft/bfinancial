...
// import { createClientPayment, fetchOffers } from "@/app/lib/actions";
...
//     setEnterpriseSelected(OmieEnterpriseEnum[currentValue as any]);
//   }
...
//                   {currentOffer.lista_parcelas.parcela.length} Parcela(s)
//                   <ChevronUpIcon
//                     className={cn(
